                    ...
                    <form id="register-frm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <input type="text" name="fullname" id="fullname" placeholder="Enter Full Name" autofocus class="form-control form-control-sm form-control-border" value="<?= isset($fullname) ? $fullname : "" ?>" required>
