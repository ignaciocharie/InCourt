                        ...
                        <div class="callout callout-primary border-primary rounded-0">
                            <dl>
                                ...
                                <dd class=" lh-1">
                                    ...
                                    <br>
                                    <div style="font-weight: bolder;">Price: <?php echo $row['price'] ?></div>
                                </dd>
                            </dl>
                        </div>
                    </a>
...
<div class="card card-outline card-primary shadow rounded-0">
    <div class="card-header">
        <h3 class="card-title"><b>Search Date</b></h3>
    </div>
    <div class="container my-5">
            ...
            <div class="col-md-12">
                ...
                <div class="input-group mb-3">
                    <input type="search" name="search" class="form-control" placeholder="Search Here" aria-label="Search Here" aria-describedby="basic-addon2">
                    <div class="input-group-append">
                        <button class="input-group-text bg-orange" style="font-size: 12px;" name="submit">Search</button>
                    </div>
                </div>
                </div>
            </form>
            ...
            <div class="container my-5">
                <table class="table">
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        $sql="Select * from `booking_list` where date_to='$search'";
                        ...
                        if($result){
                            if(mysqli_num_rows($result)>0){
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">'.date("h:iA", strtotime($row['start_time'])).'</td>
                                    <td class="text-center">'.date("h:iA", strtotime($row['end_time'])).'</td>
